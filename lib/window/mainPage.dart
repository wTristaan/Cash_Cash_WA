import 'package:cash_cash/window/image.dart';
...
class MainPage extends StatefulWidget {
  ...
  const MainPage({Key? key, required this.theme}) : super(key: key);
  @override
...
class _MainPageState extends State<MainPage> with TickerProviderStateMixin {
  ...
  Widget historique() {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Historique de detections"),
      ),
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          SpeedDialChild(
            ...
            label: "Nouvelle detection",
            onTap: () => () => setState(() => openCam = !openCam),
  ...
  // Historique à l'ouverture de l'application
  @override
  Widget build(BuildContext context) {
    if(!openCam) {
      return historique();
    } else if(openCam) {
      return const OpenCamera();
    } else {
